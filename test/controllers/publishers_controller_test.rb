...
class PublishersControllerTest < ActionController::TestCase
  ...
  test "should create publisher" do
    assert_difference('Publisher.count') do
      post :create, publisher: { address: @publisher.address, city: @publisher.city, name: Faker::Name.name, phone: @publisher.phone, state: @publisher.state, url: @publisher.url, zip: @publisher.zip }
    end
